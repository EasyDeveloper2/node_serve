...
router.get("/userInfo",(req,res,next)=>{
   co(function*(){
       ...
       var userInfo = yield  user.findOne({
           'attributes': ['id','name', 'avatorUrl','wxQRSrc','showReward','email','allowCopy','showComment',"motto","github","weibo","twitter"],
           where:{
               id:id
           }
       })
       ...
       if(userInfo != null){
           ...
           userInfo.classfyNum = apps.length
           userInfo.articleNum = articles.length
